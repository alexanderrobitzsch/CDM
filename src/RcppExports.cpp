...
Rcpp::List cdm_rcpp_din_validate_update_qmatrix(Rcpp::IntegerMatrix qmatrix_poss, Rcpp::IntegerMatrix attr_patt, Rcpp::NumericMatrix Ilj, Rcpp::NumericMatrix Rlj, int I, int L, int K);
RcppExport SEXP _CDM_cdm_rcpp_din_validate_update_qmatrix(SEXP qmatrix_possSEXP, SEXP attr_pattSEXP, SEXP IljSEXP, SEXP RljSEXP, SEXP ISEXP, SEXP LSEXP, SEXP KSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(cdm_rcpp_din_validate_update_qmatrix(qmatrix_poss, attr_patt, Ilj, Rlj, I, L, K));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::NumericMatrix cdm_rcpp_discrimination_index_calc_dich(Rcpp::IntegerMatrix comp_matrix, Rcpp::NumericVector probs, Rcpp::NumericVector dim_probs, int K);
RcppExport SEXP _CDM_cdm_rcpp_discrimination_index_calc_dich(SEXP comp_matrixSEXP, SEXP probsSEXP, SEXP dim_probsSEXP, SEXP KSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type K(KSEXP);
    rcpp_result_gen = Rcpp::wrap(cdm_rcpp_discrimination_index_calc_dich(comp_matrix, probs, dim_probs, K));
    return rcpp_result_gen;
END_RCPP
}
// cdm_rcpp_discrimination_index_test_level
double cdm_rcpp_discrimination_index_test_level(Rcpp::NumericMatrix discrim_item);
RcppExport SEXP _CDM_cdm_rcpp_discrimination_index_test_level(SEXP discrim_itemSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type discrim_item(discrim_itemSEXP);
    rcpp_result_gen = Rcpp::wrap(cdm_rcpp_discrimination_index_test_level(discrim_item));
    return rcpp_result_gen;
END_RCPP
}
